    ...
    <div class="mt-8">
        <form action="#" autoComplete="off">
            ...
            <div class="flex items-center justify-center mt-6">
                <a href="#" target="_blank" class="inline-flex items-center text-xs font-thin text-center text-gray-500 hover:text-gray-700 dark:text-gray-100 dark:hover:text-white"  onClick={navigation.push("/Register")}>
                    <span class="ml-2">
